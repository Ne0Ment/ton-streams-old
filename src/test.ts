...
async function main() {
    ...
    const channelS = tonweb.payments.createChannel({
        ...channelConfig,
        isA: false,
        myKeyPair: keyPairS,
        hisPublicKey: keyPairV.publicKey,
    });

    const channelV = tonweb.payments.createChannel({
        ...channelConfig,
        isA: true,
        myKeyPair: keyPairV,
        hisPublicKey: keyPairS.publicKey,
    });
